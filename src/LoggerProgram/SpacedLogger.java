...
public class SpacedLogger implements Logger{
	...
	public void Log(String log) {
		...
		//adds the spaces to whatever string log becomes.
	...
	public void Error(String error) {
		...
		//adds the spaces to whatever string error becomes.
		...
		int errorLength = 13 + error.length(); 
			...
			for(int i = 0; i < errorLength; i++) {
				...
				//prints out line of * that matches the length of the middle line no matter how long the String error is. 
